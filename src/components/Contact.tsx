          ...
          >
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <div>
                  ...
                  <p className="font-medium group-hover:text-primary transition-colors">zionsmith891@outlook.com</p>
                </div>
              </a>
              ...
              >
                ...
                <div>
                  ...
                  <p className="font-medium group-hover:text-primary transition-colors">+1 (805) 395-9028</p>
                </div>
              </a>
              ...
              <div className="flex items-center gap-4 glass-card p-4">
                ...
                <div>
                  ...
                  <p className="font-medium">Moreno Valley, CA, United States</p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-8">
              ...
              <div className="flex gap-3">
                ...
                <a href="zionsmith891@outlook.com" className="social-icon">
                  <Mail size={20} />
                </a>
              </div>
            </div>
